...
@:dox(hide) class ApplicationMain {
	...
	public static function main () {
		...
		var config = {
			...
			file: "Platformer",
			fps: 60,
			name: "Structure Haxe OpenFL",
			orientation: "landscape",
			packageName: "com.isartdigital.Platformer",
			version: "1.0.0",
			windows: [
	...
	public static function create (config):Void {
		...
		app.meta["build"] = "12";
		app.meta["company"] = "Platformer";
		app.meta["file"] = "Platformer";
		app.meta["name"] = "Structure Haxe OpenFL";
		app.meta["packageName"] = "com.isartdigital.Platformer";
		...
		app.window.context.attributes.background = 9474190;
	...
	macro public static function getEntryPoint () {
		...
		switch (Context.follow (Context.getType ("com.isartdigital.Main"))) {
			...
			case TInst (t, params):
				...
				if (hasMain) {
					...
					return Context.parse ("@:privateAccess com.isartdigital.Main.main ()", Context.currentPos ());
					...
					Context.fatalError ("Main class \"com.isartdigital.Main\" has neither a static main nor a constructor.", Context.currentPos ());
					
				}
				
			default:
				
				Context.fatalError ("Main class \"com.isartdigital.Main\" isn't a class.", Context.currentPos ());
...
@:keep @:dox(hide) class DocumentClass extends com.isartdigital.Main {}
